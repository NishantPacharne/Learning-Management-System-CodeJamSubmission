...
urlpatterns = [
    ...
    path('student_demo_login', views.student_demo_login, name="student_demo_login_pg"),
    path('teacher_demo_login', views.teacher_demo_login, name="teacher_demo_login_pg"),
